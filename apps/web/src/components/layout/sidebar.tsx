...
import { LayoutDashboard, Users, Briefcase, Building2, FileText, Settings, LogOut, Upload, BookOpen, Files, BarChart3, ChevronLeft, ChevronRight, GraduationCap } from 'lucide-react'
...
const navItems = [
  ...
  { name: 'Importaciones', href: '/imports', icon: Upload, roles: ['ADMIN'] },
