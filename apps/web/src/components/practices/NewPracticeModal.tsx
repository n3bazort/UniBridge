...
export function NewPracticeModal({
  ...
  useEffect(() => {
    if (practiceToEdit) {
      ...
      setStudentLabel(practiceToEdit.student ? `${practiceToEdit.student.firstName} ${practiceToEdit.student.lastName}` : '')
      setCompanyId(practiceToEdit.companyId || (practiceToEdit.company?.id) || '')
